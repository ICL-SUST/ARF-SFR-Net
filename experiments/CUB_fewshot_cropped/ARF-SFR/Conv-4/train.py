...
sys.path.append('../../../../')
from trainers import trainer, arfsfr_train
from datasets import dataloaders
from models.ARFSFR import ARFSFR
...
model = ARFSFR(way=train_way,
            shots=[args.train_shot, args.train_query_shot],
            resnet=args.resnet)

train_func = partial(arfsfr_train.default_train,train_loader=train_loader)
