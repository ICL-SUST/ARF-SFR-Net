...
def get_transform(is_training=None,transform_type=None,pre=None):
    ...
    if is_training:
        ...
        # size_transform = transforms.Compose([transforms.ToTensor(),
        #                                      transforms.Normalize(mean=mean, std=std),
        #                                      transforms.Resize(136, interpolation=InterpolationMode.NEAREST),
        ...
        if transform_type == 0:
            size_transform = transforms.Compose([transforms.Resize(92),   # 110  180
                                                transforms.CenterCrop(84)])   # 100  168
        elif transform_type == 1:
