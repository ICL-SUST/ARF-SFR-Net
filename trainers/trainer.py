...
def train_parser():
    ...
    parser.add_argument("--opt",help="optimizer",choices=['adam','sgd'],default='sgd')  # sgd
    parser.add_argument("--lr",help="initial learning rate",type=float,default=1e-1)   # 1e-1
    parser.add_argument("--gamma",help="learning rate cut scalar",type=float,default=1e-1)
    ...
    parser.add_argument("--weight_decay",help="weight decay for optimizer",type=float,default=5e-4)  #5e-4
    ...
    parser.add_argument("--resnet", help="whether use resnet12 as backbone or not",action="store_true",default=False) # default=False
    ...
    parser.add_argument("--no_val", help="don't use validation set, just save model at final timestep",action="store_true")  # ,default=True
